...
def test_rbac_filter_blocks_unauthorized_role():
    specs = [
...
def test_module_filter_blocks_disabled_module():
    specs = [
...
def test_capability_filter_blocks_denied():
    specs = [
...
def test_triple_filter_combined():
    specs = [
...
def test_platform_admin_sees_all_role_restricted():
...
def test_enabled_modules_none_skips_module_filter():
