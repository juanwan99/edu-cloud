...
| review-gap 边界 | 旧回执日志末条 | 末条 receipt = `2026-06-07T14:40:06` `engine_review` `PASS` `reviewed_sha=3688f32`，findings=0 |
...
- review-gap 边界：`legacy receipt log` 末条 = 06-07 14:40 `PASS@3688f32`
