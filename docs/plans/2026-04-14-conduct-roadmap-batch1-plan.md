...
|---|---|---|---|
| T5 文档 post-T-Wipe 验证 | — | `/home/ops/projects/edu-cloud/CLAUDE.md`（T-Wipe 已清洗，仅验证）+ `docs/plans/2026-04-13-conduct-next-phase-handoff.md`（Phase 6 或本 Task 按 L018 处置） | — |
...
- Verify-or-clean: `docs/plans/2026-04-13-conduct-next-phase-handoff.md`（handoff 文件；Phase 6 处置或本 Task 补漏）
...
Run:
```bash
grep -nE "\b1[0-2][0-9]\s+passed|\b1[0-2][0-9]\s*\+\s*1[0-2]" docs/plans/2026-04-13-conduct-next-phase-handoff.md 2>/dev/null
```
...
cd /home/ops/projects/edu-cloud && git reset HEAD >/dev/null 2>&1 && \
  git add docs/plans/2026-04-13-conduct-next-phase-handoff.md docs/plans/2026-04-14-conduct-roadmap-batch1-state.json && \
