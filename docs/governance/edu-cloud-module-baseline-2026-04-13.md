...
> 设计依据: `docs/archive/plans/2026-04-13-module-governance-design.md` §3.3
...
- **证据**:
  ...
  - git log（`retired-archived-plan-history`）显示 scan/tpl_parser.py 在 scan 集成时新建，card/tpl_parser.py 先于 scan 存在
