...
- **做什么**：查询 student_exam_snapshots/student_knowledge_mastery/student_error_patterns 三张表的聚合数据；班级维度薄弱知识点聚合（avg mastery 排序）；AI 诊断端点（委托 analytics.insights_service）
