"""Canonical auth dependencies — get_current_user / require_permission.

Moved from ``edu_cloud.api.deps`` (H-4 reverse-dependency elimination).
Module routers import from here; ``api.deps`` re-exports for backwards compat.
"""
