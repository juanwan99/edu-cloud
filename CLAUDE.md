...
# 前端（Vite dev server）
cd /home/ops/projects/edu-cloud-t2/frontend
npm run dev
...
cd /home/ops/projects/edu-cloud-t2 && .venv/bin/python -m pytest --tb=short -q

# 前端 Vitest + happy-dom
cd /home/ops/projects/edu-cloud-t2/frontend && npx vitest run
```
<!-- key-end -->
