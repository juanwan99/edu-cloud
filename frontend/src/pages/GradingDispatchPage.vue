...
.page-subtitle { font-size: 16px; color: #8a9a8e; margin-top: 2px; }
...
.empty-state { padding: 60px 0; text-align: center; color: #8a9a8e; font-size: 16px; }
...
.verify-total { font-size: 16px; color: #888; }
