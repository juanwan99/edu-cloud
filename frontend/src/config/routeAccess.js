...
export const ROUTE_ACCESS_REQUIREMENTS = {
  ...
  '/academic/teaching-plans': { permission: 'manage_scheduling', moduleCode: 'teaching' },
  '/academic/timetable': { permission: 'manage_scheduling', moduleCode: 'teaching' },
  '/academic/semesters': { permission: 'manage_scheduling', moduleCode: 'teaching' },
